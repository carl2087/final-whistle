"""
Django settings for thefinalwhistle project.
...
ALLOWED_HOSTS = ['the-final-whistle.herokuapp.com', 'localhost']
...
ROOT_URLCONF = 'thefinalwhistle.urls'
...
WSGI_APPLICATION = 'thefinalwhistle.wsgi.application'
